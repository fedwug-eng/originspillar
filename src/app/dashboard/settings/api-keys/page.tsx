        ...
        <div className="space-y-6 max-w-3xl">
            ...
            {showAddForm && (
                <GlassCard className="p-5 space-y-4">
                    ...
                    <p className="text-xs text-white/30">Keys are stored securely (SHA-256 hashed) and masked after saving.</p>
                </GlassCard>
            )}
            ...
            {loading ? (
                ...
                <GlassCard className="p-12 text-center">
                    ...
                    <p className="text-sm font-medium text-white/50">No API keys yet</p>
                    <p className="text-xs text-white/30 mt-1">Add your first key to connect third-party services</p>
                </GlassCard>
            ) : (
